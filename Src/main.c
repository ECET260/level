...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, ARD_D10_Pin|LCD_D4_Pin|LCD_D7_Pin|SPBTLE_RF_RST_Pin 
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, USB_OTG_FS_PWR_EN_Pin|LCD_D2_Pin|PMOD_RESET_Pin|STSAFE_A100_RESET_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : ARD_D10_Pin LCD_D4_Pin LCD_D7_Pin SPBTLE_RF_RST_Pin 
                           LCD_D1_Pin */
  GPIO_InitStruct.Pin = ARD_D10_Pin|LCD_D4_Pin|LCD_D7_Pin|SPBTLE_RF_RST_Pin 
                          |LCD_D1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
